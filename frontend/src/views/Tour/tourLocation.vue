<template>
  <div class="contents">
    <div class="event-box">
      <div class="top-txt">
        <h3 v-if="festivalData !== ''">{{ selectArea.si }} {{ selectArea.gun }} 행사정보입니다</h3>
        <h3 v-if="festivalData === ''">{{ selectArea.si }} {{ selectArea.gun }} 행사정보가 없습니다.</h3>
        <span v-if="festivalData !== ''">관심있는 행사 정보를 찾아보세요</span>
      </div>
